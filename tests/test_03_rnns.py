...
def test_rnn_shapes() -> None:
    mod = _load("src/03_rnns/00_rnn_shapes.py")
    out, h = mod.main()
...
def test_lstm_shapes() -> None:
    mod = _load("src/03_rnns/01_lstm_shapes.py")
    out, h, c = mod.main()
...
def test_gru_shapes() -> None:
    mod = _load("src/03_rnns/02_gru_shapes.py")
    out, h = mod.main()
...
def test_manual_rnn_cell() -> None:
    mod = _load("src/03_rnns/03_manual_rnn_cell.py")
    h = mod.main()
...
def test_sin_sequence() -> None:
    mod = _load("src/03_rnns/04_sin_sequence.py")
...
def test_packed_sequence() -> None:
    mod = _load("src/03_rnns/05_packed_sequence.py")
...
def test_embedding() -> None:
    mod = _load("src/03_rnns/06_embedding.py")
    out = mod.main()
